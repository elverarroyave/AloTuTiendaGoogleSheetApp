...
## Necesidad
Nesito crear un formulario para crear un nuevo control de ingreso en mi proyecto, este formulario debe estar construido con html, bootstrap javascript y Apps Script
Debe tener como entrada el: Producto*(Un select autocompletable que muestre el nombre el código del producto ej: Aire acon inv 12000 btu 220 Es SIMPLY TURN (PDCT057)), Proveedor*, Cantidad*, Precio unitario*, Método de pago*, Quien recibe, un select con dos opciones(Elver Arroyave, Katy Iriarte) y campo de texto llamado enlace de factura opcional, estado(un select simple con estas opciones: EN ESPERA RECIBIDO, DEVOLUCION, RECLAMO). los campos marcados con asterisco(*) son obligatorios. Un boton al final del formulario que me permita registrar el ingreso, que se habilite solo cuando los campos obligatorios esten completados. Se debe crear en un nuevo menu llamado "Control Ingreso" con item "Ingresar pedido"

Requisitos
**El método de pago se debe ser un select autocompletable, los valores se deben obtener de la tabla "METODO_DE_PAGO" (Solo se deben mostrar los métodos de pago activos)
Esta es la estructura completa de la tabla METODO_DE_PAGOS actualmente, debes tomar el rango hasta la fila 9
        | A                          |B    |C       |D      
1       |               METODO DE PAGO                       |
2       | NOMBRE                     | num | CODIGO | ACTIVO |
3       |----------------------------|-----|--------|--------|
4       | EFECTIVO                   | 1   | MDP001 | TRUE   |
5       | VISA CLASICA BANCOLOMBIA   | 2   | MDP001 | TRUE   |
6       | NU BANK                    | 3   | MDP001 | TRUE   |
7       | CMR FALABELLA              | 4   | MDP001 | TRUE   |
8       | NU BANK KATTY              | 5   | MDP001 | TRUE   |
9       | T.C. TUYA EXITO            | 6   | MDP001 | TRUE   |

**El proveedor debe ser un select autocompletable, los valores se deben obtener de la tabla "PROVEEDORES" (Solo se deben mostrar los proveedores activos)
Esta es la estructura completa de la tabla PROVEEDORES actualmente, debes tomar el rango hasta la fila 13

|   | A       | B   | C       | D      | E                                             | F                | G        | H                     |
|---|---------|-----|---------|--------|-----------------------------------------------|------------------|----------|------------------------|
| 1 | NOMBRE  | NUM | CODIGO  | ACTVIO | ENLACE                                        | CONTACTO GARANTÍA| CIUDAD   | CREATED_DATETIME       |
| 2 | Meico           | 1   | PROV001 | TRUE   |                                           |                  | Caucasia | 11/19/2024 0:00:00     |
| 3 | Tienda exito    | 2   | PROV002 | TRUE   | https://tienda.exito.com/                 |                  | Online   | 11/20/2024 0:00:00     |
| 4 | Linio           | 3   | PROV003 | TRUE   | https://www.linio.com.co/                 |                  | Online   | 11/21/2024 0:00:00     |
| 5 | Mercadolibre    | 4   | PROV004 | TRUE   | https://www.mercadolibre.com.co/          |                  | Online   | 11/22/2024 0:00:00     |
| 6 | Amazon          | 5   | PROV005 | TRUE   | https://www.amazon.com/                   |                  | Online   | 11/23/2024 0:00:00     |
| 7 | Technologystore | 6   | PROV006 | TRUE   | https://www.technologystore2006.com       |                  |          | 11/24/2024 0:00:00     |
| 8 | Colombiapc      | 7   | PROV007 | TRUE   | https://colombiapc.com/                   |                  |          | 11/25/2024 0:00:00     |
| 9 | Falabella       | 8   | PROV008 | TRUE   | https://www.falabella.com.co/falabella-co | 6015878002       | Online   | 11/26/2024 0:00:00     |
|10 | Bancolombia 360 | 9   | PROV009 | FALSE  | https://tu360compras.grupobancolombia.com/|                  | Online   | 11/27/2024 0:00:00     |
|11 | Homecenter      | 10  | PROV010 | TRUE   |                                           |                  |          | 11/28/2024 0:00:00     |
|12 | GIFTRONIC04     | 11  | PROV011 | TRUE   | https://giftronic04.com/                  | 3053404834       | Online   | 11/29/2024 0:00:00     |
|13 | HYUNDAI         | 12  | PROV012 | FALSE  |                                           | 3008217999       |          | 11/30/2024 0:00:00     |
...
5      |4	   |INGRESO	        |IN	   |185    |186 <----- Secuencia que corresponde a control ingreso
6      |5	   |METODO DE PAGO  |MDP   |6      |7   <----- Secuencia para el método de pago
7      |6	   |PROVEEDOR       |PROV  |12     |13   <----- Secuencia para el proveedor

al Ingreso actual le debe asignar la secuencia siguiente(NEXT) y luego debe actualizar la tabla, remplazando el valor CURRENT de la secuencia correspondiente
con el valor NEXT recuperado anteriormente, de esta forma el valor NEXT se actualizará automaticamente, dado que esa celda tien una formula(=D5+1)

CONTROL INGRESO es el nombre de la tabla donde se debe insertar el producto, tiene algunos INGRESOS ya insertados con la siguiente estructura
|   | A            | B       | C           | D                   | E        | F            | G        | H        | I        | J                | K        | L        | M                   |
|---|--------------|---------|-------------|---------------------|----------|--------------|----------|----------|----------|-------------------|----------|----------|----------------------|
| 1 |                                                                                          CONTROL INGRESO                                                                               |
| 2 | FECHA        | NUM_IN  | COD_INGRESO | EMPLEADO QUE RECIBE | COD_PROV | PROVEEDOR    | COD_PRDT | PRODUCTO | CANTIDAD | PRECIO UNITARIO  | MÉTODO DE PAGO | TOTAL    | ESTADO | ENLACE DE FACTURA |
| 3 | 11/11/25 0:00 | 185     | IN185       | KATY IRIARTE        | PROV002  | Tienda exito | PDCT090  | Televisor CAIXUN 55 pulgadas LED Uhd4K Smart TV C55VAUG | 2 | $1,100,000 | T.C. TUYA EXITO | $2,200,000 | RECIBIDO | |
| 4 | 11/12/25 0:00 | 184     | IN184       | ELVER ARROYAVE      | PROV008  | Falabella    | PDCT073  | Televisor JVC 43 pulgadas LED Full HD Smart TV | 2 | $832,000 | CMR FALABELLA | $1,664,000 | EN ESPERA | |
| 5 | 11/12/25 0:00 | 183     | IN183       | ELVER ARROYAVE      | PROV004  | Mercadolibre | PDCT078  | Combo Barril 28 Libras + Acc. Base + Choricera Pq + 2 Cajas de Carbón + Condimentos La Moza y El Matrimonio + Recetario | 2 | $499,000 | EFECTIVO | $998,000 | RECIBIDO | |
| 6 | 11/12/25 0:00 | 182     | IN182       | ELVER ARROYAVE      | PROV008  | Falabella    | PDCT089  | Portatil HP 14 Intel core i3 8GB RAM 512GB SSD | 2 | $1,012,000 | CMR FALABELLA | $2,024,000 | RECIBIDO | |
| 7 | 11/19/25 0:00 | 181     | IN181       | KATY IRIARTE        | PROV008  | Falabella    | PDCT081  | Batería 10 Piezas Antiadherente Gris Imusa | 5 | $187,900 | CMR FALABELLA | $939,500 | RECIBIDO | |
| 8 | 10/3/25 9:09  | 180     | IN180       | ELVER ARROYAVE      | PROV004  | Mercadolibre | PDCT083  | Hidrolavadora FEMMTO 1400W 1600PSI | 4 | $212,900 | EFECTIVO | $851,600 | RECIBIDO | |
| 9 | 10/2/25 13:53 | 179     | IN179       | KATY IRIARTE        | PROV001  | Meico        | PDCT087  | Ventilador De Techo Altezza Vento Café | 8 | $196,225 | EFECTIVO | $1,569,800 | RECIBIDO | |


Los campos de esta tabla que se debe completar son:
 - fecha
 - NUM_IN
 - COD_INGRESO
 - EMPLEADO QUE RECIBE
 ...
 - CANTIDAD
 - PRECIO UNITARIO
 - ENLACE FACTURA (Solo si se carga)
