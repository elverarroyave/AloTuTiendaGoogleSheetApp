...
## Necesidad
Nesito crear un formulario para crear un abono en mi proyecto, este formulario debe estar construido con html, bootstrap javascript y Apps Script
Debe tener como entrada el: Código de venta*, Valor del abono*(input tipo saldo) y Método de pago*(Select autocompletable). los campos marcados con asterisco(*) son obligatorios. Un boton al final del formulario que me permita registrar el Abono(Abonar) que se habilite solo cuando los campos obligatorios esten completados. Se debe crear en un nuevo menu llamado "Abonar" con item "Nuevo Abono"

El código del abono debe obtenerse usando la funcion getSequences() para obtener todas las sequencias, función que ya existe en otro script.gs
...
8      |7	   |INGRESO EGRESO  |INOUT |1102   |1103  <----- Secuencia actual
...
INGRES0S_EGRESOS es el nombre de la tabla donde se debe insertar el producto, tiene algunos clientes ya insertados con la siguiente estructura
|   | A        | B          | C   | D      | E         | F                                   | G        | H       | I       | J       | K        | L        |
|---|----------|------------|-----|--------|-----------|--------------------------------------|----------|---------|---------|---------|----------|----------|
| 1 | FECHA    | REFERENCIA | NUM | CODIGO | COD_VENTA | CLIENTE                              | PRODUCTO | DETALLE | ENTRADA | SALIDA  | M PAGO   | TOTAL    |
| 2 | 11/14/2025 0:00:00 | ABONO | 1100 | INOUT1100 | VENTA394 | JAIRO ANDRES FRANCO HERNANDEZ | Ventilador De Techo Altezza Vento Café | | $85,000  |         | B/bia K | $85,000  |
| 3 | 11/14/2025 0:00:00 | ABONO | 1101 | INOUT1101 | VENTA256 | Daneis Milena Garcia Mercado | Lavadora doble tina haceb 7kg | | $50,000  |         | Efectivo | $50,000 |
| 4 | 11/13/2025 0:00:00 | ABONO | 1098 | INOUT1098 | VENTA394 | JAIRO ANDRES FRANCO HERNANDEZ | Ventilador De Techo Altezza Vento Café | | $85,000  |         | B/bia K | $85,000 |
| 5 | 11/13/2025 0:00:00 | ABONO | 1099 | INOUT1099 | VENTA399 | JAIRO ANDRES FRANCO HERNANDEZ | Ventilador De Techo Altezza Vento Café | | $85,000  |         | B/bia K | $85,000 |

Los campos de esta tabla que se debe completar son:
- FECHA: Fecha y hora actual 
- REFERENCIA: "ABONO"
- CODIGO: La secuencia obtenida
- COD_VENTA: El código de venta ingresado por el usuario
- ENTRADA: El valor del abono ingresado por el usuario
